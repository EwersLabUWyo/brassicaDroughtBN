...
```
Now let's look at an example where the distribution *does* change. Let's revisit the original example with rjags and see how LO changes with PR. 
...
These distributions line up well with the distributions found through rjags. 
